        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="mb-10">
            <h1 className="text-3xl md:text-4xl font-bold mb-4 font-headline">
              Join Variant Research
            </h1>
            <p className="text-muted-foreground">
              Start your 100% independent research journey today. No ads, no
              noise, just data.
            </p>
          </div>
        ...
        <div className="max-w-md space-y-16">
          <div className="space-y-8">
            ...
            <h3 className="text-2xl font-medium leading-relaxed text-foreground">
              &quot;The depth of analysis in Variant&apos;s reports rivals what
              I used to see on the sell-side, but without the conflict of
              interest. It&apos;s the only subscription I expensed this
              year.&quot;
            </h3>
            <div>
